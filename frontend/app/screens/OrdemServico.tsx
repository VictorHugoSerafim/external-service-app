      ...
      <View style={[$bottomContainer, $bottomContainerInsets]}>
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={$scrollViewContent}>
          ...
          {selectedFiles.map((file, index) => (
            <Text key={index} style={{ fontSize: heightPercentageToDP('2%') }}>
...
function updateFiles(prevFiles: DocumentPickerResponse[], result: DocumentPickerResponse[]): DocumentPickerResponse[] {
